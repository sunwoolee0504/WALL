...
class DMAQ_qattenLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        mac_out_temp = copy.deepcopy(mac_out_temp)
        ...
        if self.mixer is not None:
            if self.args.mixer == "dmaq_qatten":
                ...
                total_q_qmix_normal = ans_chosen.clone().detach()
            else:
        ...
        with th.no_grad():
            ...
            total_q_qmix_attack_temp = self.mixer(indi_q_slided, state_slided, is_v=True)
            ...
            for _ in range(self.args.attack_duration):
                ...
                total_q_qmix_attack_temp = self.mixer(indi_q_slided, predict_state, is_v=True)
                attacked_total_q[batch_indices, time_indices, initial_agent_t] += total_q_qmix_attack_temp
